...
<!-- SITE TITLE -->
<title><?= $caterogoria_nom ?> | VIÑASANTODOMINGO</title>
<!-- Favicon Icon -->
...
<body>
    ...
    <div class="main_content">
        ...
        <!-- START SECTION SHOP -->
        <div class="section bgwine" style="padding-top: 29px;">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="pagination mt-3 justify-content-center pagination_style1">
                                    <li v-on:click="setSwithHoja(-1)" class="page-item"><a class="page-link"
                                            href="javascript:void(0)"><i class="linearicons-arrow-left"></i></a></li>

                                    <li v-for="item  in getPagNum"
                                        :class="hojaActual==item?'page-item active':'page-item'"
                                        v-on:click="setNumHoja(item)"><a class="page-link"
                                            href="javascript:void(0)">{{item}}</a></li>

                                    <li v-on:click="setSwithHoja(1)" class="page-item"><a class="page-link"
                                            href="javascript:void(0)"><i class="linearicons-arrow-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                " class="widget_title">Filtrar por</h5>
                                    ...
                                    <div style="padding: 11px;">
                                            ...
                                            <ul class="list_brand">
                                                <li>
                                                    <div class="custome-checkbox">
                                                        <input class="form-check-input" type="checkbox" name="en-stock"
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="filter_price">
                                                <span onclick="APP_PROD.getFiltrar()" class="on-click-cont"
                                                    style="/* left: 115%; */padding-left: 8px;padding-top: 3px;/* top: -15px; */width: 30px;border-radius: 5px;height: 30px;float: right;background-color: #c7161d !important;/* margin-bottom: 200px; */color: white;bottom: 15px;position: relative;"><i
                                                        class="fa fa-search"></i></span>
                                                <div style="width: 80%" id="price_filter" data-min="0" data-max="5000"
                                                    data-min-value="0" data-max-value="5000" data-price-sign="$"
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="" style="overflow: hidden;" id="fitrarPor">
                                                <div class="box-fil-por" onclick="selecSubC(-1)">TODO</div>
                                            </div>
                                        </div>
                ...
                for (var i = 0; i < this.listaProdGene.length; i++) {
                    ...
                    if (precioProd >= this.valueUSDMin && precioProd <= this.valueUSDMax) {
                        if (this.listaMarcaFiltro.length > 0) {
                            ...
                            if (this.filterSubC != -1) {
                                if ((this.filterSubC + "") != (this.listaProdGene[i].sub_cat + "")) {
                                    valueDE = false;
                                }
