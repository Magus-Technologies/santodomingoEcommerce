       ...
       case 'prodce-prod':
        ...
        distrito_id =null, direccion='{$_POST['direccion']}',tipo_pago ='{$_POST['formaPagoAgregar']}',tipo_envio ='{$_POST['formEnvioAgregar']}',distrito_opcional ='{$_POST['distritoOpcionalAgregar']}'";
            ...
            if ($conexion->query($sql)) {
                ...
                // Crear cotización vía API interna de Laravel
                try {
                    ...
                    // No bloquea el pedido si falla la cotización
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td style="text-align: center; color: black">
            <h2><strong>Te saluda VI�ASANTODOMINGO</strong></h2>
          </td>
        </tr>
        <tr>
          <td style="font-size: 0; line-height: 0;" height="10">&nbsp;</td>
        ...
        <tr>
          ...
          Hola  ' . $correoSus . ' te saluda VI�ASANTODOMINGO, tu cotizacion se esta procesando <br><br>
          </td>
        </tr>
        <tr>
            <td style="text-align: center; color: black">
  ...
  <tr>
    <td bgcolor="#1c15f7" style="padding: 30px 30px 30px 30px;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td style="color: white" width="75%">
            &reg; VI�ASANTODOMINGO <br/>
    ...
    ';
                    ...
                    //ob_start();
                    $ressss = $email->de(USER_SMTP, "VI�ASANTODOMINGO")
                        ->addEmail($_SESSION['email'], "VI�ASANTODOMINGO")
  ...
  case "chg-vip-user":
	...
	$sqlf = "SELECT vip_id FROM usuarios_vip WHERE use_id='{$_SESSION['usuario']}'";
	$resulta = $conexion->query($sqlf);
        foreach ($resulta as $rowped) {
		$vip = $rowped['vip_id'];
 	}
	if ($vip =="") {
     	$sql ="INSERT INTO usuarios_vip VALUES (0,'{$_SESSION['usuario']}',0,CURRENT_TIMESTAMP())";
	  $result = $conexion->query($sql);
	  $respuesta['res'] = true; 
	} else {
	  $respuesta['res'] = true;
